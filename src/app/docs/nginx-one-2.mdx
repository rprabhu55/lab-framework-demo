...
1. Repeat the previous steps for any remaining **<GetVariable name="petname" />** instances.
...
1. Repeat the previous step, this time for the **<GetVariable name="petname" />-oss** Config Sync Group.

...
1. Now let's add two NGINX Open Source instance in this Config Sync Group. Select *Run* for each NGINX OSS instances below. As a convenience, the dataplane key and Config Sync Group have already been provided to the containers.

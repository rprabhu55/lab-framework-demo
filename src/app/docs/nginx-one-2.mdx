...
1. When you select the *Configuration* tab, notice the config here is the same as what was in the NGINX instance you just created.
...
1. Return to the *Details* tab on the console to verify that the two new NGINX OSS instances have been added to the **<GetVariable name="petname" />-oss** Config Sync Group:
    ...
    ![NGINX OSS instances appear in the oss config sync group](media/lab5-26.png)

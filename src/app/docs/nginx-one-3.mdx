...
1. In the N1SC console, navigate to *Instances*. You will see a new NGINX Plus instance added to the NGINX One Console. This instance will be randomly named based on the Docker container that was created, since a name was not provided.

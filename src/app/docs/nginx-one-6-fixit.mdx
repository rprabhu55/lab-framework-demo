...
Once the NGINX containers have been successfully added to your config sync group, you will notice that the group will be out-of-sync and unable to resolve itself. Your objective is to find out why this is happening and resolve the issue.

...
Plus](https://www.nginx.com/products/nginx) itself uses a native 
...
| ----------------------------- | ----------------- | -------------------- |
| JumpHost Windows Server 2019  | RDP Access        | ``user`` /  ''user'' |

To get started with the lab exervises, open an RDP session to the ``Windows
server 2019 JumpHost > Access > RDP``

![UDF RDP Access](https://github.com/f5devcentral/f5-agility-labs-nginx/raw/develop/docs/class1/images/rdp_jumphost.png)
...
![RDP Login](https://github.com/f5devcentral/f5-agility-labs-nginx/raw/develop/docs/class1/images/rdp_credentials_jumphost.png)

The Windows JumpHost is now ready for the lab

![RDP Desktop](https://github.com/f5devcentral/f5-agility-labs-nginx/raw/develop/docs/class1/images/lab_desktop.png)